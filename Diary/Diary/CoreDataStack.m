...
//Creates a singleton of our CoreData class and initializes it ONLY ONCE (dispatch_once)
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.Brwong.Diary" in the application's documents directory.
