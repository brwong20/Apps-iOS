...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //Sets up the layout of all our navigation bars using UIAppearance
...
-(void)setupAppearance{
    //Retrieves appearance proxy to set up all nav bars
    ...
    //Dictionary of different nav bar attributes - 1st one sets all text color to white
